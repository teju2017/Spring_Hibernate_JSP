...
<div class="center">
  <p>ACTIVITY TRACKING INFORMATION</p>
</div>

<div class="insert">
<div>
<!-- - <form action="/ActivitySubmission" method="GET">  -->

<form action="ActivitySubmission" modelAttribute="activityTracker" method="POST">
<div class="Core">
  ...
  <div>
    <label for="ACTIVITYLIST">ACTIVITY_LIST</label>
    <select id="Activity_list" name="Activitylist">
	  <option value="EMPTY"></option>
  ...
  <div>
    ...
    <input type="text" id="Comments" name="Comments" maxlength="100" required>
        <br></br>
  </div>
